...
const settings = {
   ...
   const experience = {
	  ...
	  description:
		  `I have done worked with few startups as Software Engineer, Frontend Developer. 
			  ...
			  experiences: [
				{
					...
					description:
						`TELUS International is a subsidiary of TELUS, 
				  ...
				  
				  {
					...
					location: "Delhi",
					description:
						`Healthmug is an E-Commerce product based company, 
				   ...
				   },
				   {
					...
					description:
						`Info Space Export was product based company, 
			  ...
			  experiences: [
				  {
					  ...
					  // location: "Gurgaon, Haryana",
					  description:
								  `I have learn there how to build native android app, 
